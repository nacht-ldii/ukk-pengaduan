                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 ">
                         <li><a href="https://maps.app.goo.gl/Gkme4bVYrFu3e9J19" style="color:white"><i class="fa fa-podcast"> Kantor Desa Peterongan Cek Lokasi disini</i></a></li>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> Desa_peterongan@gmail.com</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i>0882-2855-0498</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
if (isset($_POST['login'])) {
    ...
    if ($data_user) {
        ...
        if (mysqli_num_rows($data_user) > 0) {
            ...
            // Jika tidak ada baris yang dikembalikan, login gagal
            echo "<div class='alert alert-danger' style='margin-top:11px'>Login Gagal</div>";
            echo "<meta http-equiv='refresh' content='1;url=index.php'>";
        }
    } else {
        // Jika query tidak berhasil dijalankan
        echo "<div class='alert alert-danger' style='margin-top:11px'>Error dalam melakukan login. Silakan coba lagi.</div>";
    }
}
?>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text">
                                ...
                                <p>Selamat datang di web Pengaduan Masyarakat Desa Peterongan<br>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">DAVID</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
