...
<?php
if (!empty($data['tgl_tanggapan']) && !empty($data['tanggapan'])) {
    // Jika ada tanggapan, tampilkan tanggapan
?>
...
<?php
    ...
    // Jika tidak ada tanggapan, tampilkan pesan yang sesuai
?>
    <center><h4 style="margin-top:20px">Belum ada tanggapan</h4></center>
<?php
}
?>
<div>
